...
const Technologies = () => {
  return (
    <div className="relative pb-4">
      ...
      <h1 className="my-20 text-center text-4xl text-gray-800">
        Technologies
      </h1>
      ...
      >
        {icons.map((item, index) => (
          <motion.div
            ...
            initial="initial"
            animate="animate"
            className="rounded-2xl border-4 border-neutral-800 p-4 bg-white bg-opacity-80 shadow-lg transition-transform duration-300 hover:scale-105"
          >
            {item.icon}
          </motion.div>
        ))}
